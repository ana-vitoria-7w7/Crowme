...
<body style="margin: 0px; padding: 0px;">
    <div>
        ...
        <div id="menu" class="menu">
            ...
            <p class="bordasMenu"><a class="link" href="cadastroUsuarios.php">Cadastrar Usuário</a></p>
            ...
            <p class="bordasMenu"><a class="link" href="updateUsuarios.php">Cadastrar Filmes</a></p>
        </div>
